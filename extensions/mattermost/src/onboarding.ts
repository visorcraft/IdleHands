import type { ChannelOnboardingAdapter, IdleHandsConfig, WizardPrompter } from "idlehands/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.idlehands.ai/channels/mattermost",
    ].join("\n"),
