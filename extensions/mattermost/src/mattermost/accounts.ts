...
export function listMattermostAccountIds(cfg: IdleHandsConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: IdleHandsConfig): string {
...
export function listEnabledMattermostAccounts(cfg: IdleHandsConfig): ResolvedMattermostAccount[] {
