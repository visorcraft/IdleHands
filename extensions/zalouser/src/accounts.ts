...
export function listZalouserAccountIds(cfg: IdleHandsConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: IdleHandsConfig): string {
...
function mergeZalouserAccountConfig(cfg: IdleHandsConfig, accountId: string): ZalouserAccountConfig {
