...
import { resolveChannelMediaMaxBytes, type IdleHandsConfig } from "idlehands/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: IdleHandsConfig; accountId?: string }): string[] {
