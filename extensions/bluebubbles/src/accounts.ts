...
export function listBlueBubblesAccountIds(cfg: IdleHandsConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: IdleHandsConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: IdleHandsConfig): ResolvedBlueBubblesAccount[] {
