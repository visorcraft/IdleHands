...
This directory contains the **BlueBubbles external channel plugin** for IdleHands.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `idlehands/plugin-sdk` helpers.
