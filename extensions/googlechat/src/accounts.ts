...
export function listGoogleChatAccountIds(cfg: IdleHandsConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: IdleHandsConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: IdleHandsConfig): ResolvedGoogleChatAccount[] {
