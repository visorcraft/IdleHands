...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "idlehands/plugin-sdk";
...
import { resolvePreferredIdleHandsTmpDir } from "../../../src/infra/tmp-idlehands-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredIdleHandsTmpDir(), "msteams-mention-"));
