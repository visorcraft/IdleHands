...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "idlehands/plugin-sdk";
import {
  ACPX_PINNED_VERSION,
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: IdleHandsPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: IdleHandsPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
