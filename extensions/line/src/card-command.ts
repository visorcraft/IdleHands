import type { LineChannelData, IdleHandsPluginApi, ReplyPayload } from "idlehands/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: IdleHandsPluginApi): void {
  api.registerCommand({
    name: "card",
