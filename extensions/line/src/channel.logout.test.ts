import type { IdleHandsConfig, PluginRuntime, ResolvedLineAccount } from "idlehands/plugin-sdk";
...
async function runLogoutScenario(params: { cfg: IdleHandsConfig; accountId: string }): Promise<{
