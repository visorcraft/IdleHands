...
read_when:
  - You are building a IdleHands plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (idlehands.plugin.json)

Every plugin **must** ship a `idlehands.plugin.json` file in the **plugin root**.
IdleHands uses this manifest to validate configuration **without executing plugin
