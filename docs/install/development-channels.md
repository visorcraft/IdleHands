...
IdleHands ships three update channels:
...
When you **explicitly** switch channels with `--channel`, IdleHands also aligns
the install method:
...
When you switch channels with `idlehands update`, IdleHands also syncs plugin sources:
