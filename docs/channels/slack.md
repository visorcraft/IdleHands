...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure IdleHands HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `idlehands pairing approve slack <code>`.
...
IdleHands supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, IdleHands falls back to normal delivery for remaining payloads.
