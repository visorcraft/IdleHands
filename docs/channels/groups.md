...
IdleHands treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

IdleHands “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, IdleHands can see that group and respond there.
...
Translation: allowlisted senders can trigger IdleHands by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@idlehands", "idlehands", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
