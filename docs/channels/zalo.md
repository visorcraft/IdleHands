...
- Install via CLI: `idlehands plugins install @idlehands/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `idlehands plugins install ./extensions/zalo`
   - From npm (if published): `idlehands plugins install @idlehands/zalo`
...
- Approve via:
  - `idlehands pairing list zalo`
  - `idlehands pairing approve zalo <CODE>`
...
- Example: `idlehands message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `idlehands channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `idlehands logs --follow`
