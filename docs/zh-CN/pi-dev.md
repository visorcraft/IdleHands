...
本指南总结了在 IdleHands 中开发 Pi 集成的合理工作流程。
...
状态存储在 IdleHands 状态目录下。默认为 `~/.idlehands`。如果设置了 `IDLEHANDS_STATE_DIR`，则使用该目录。
...
- https://docs.idlehands.ai/testing
- https://docs.idlehands.ai/start/getting-started
