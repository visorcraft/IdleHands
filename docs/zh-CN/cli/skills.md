...
summary: "`idlehands skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
```bash
idlehands skills list
idlehands skills list --eligible
idlehands skills info <name>
idlehands skills check
```
