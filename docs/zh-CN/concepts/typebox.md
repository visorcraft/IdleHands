...
- 生成的 Swift 模型：`apps/macos/Sources/IdleHandsProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/idlehands/idlehands/main/dist/protocol.schema.json
