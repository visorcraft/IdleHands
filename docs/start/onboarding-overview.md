---
summary: "Overview of IdleHands onboarding options and flows"
read_when:
...
IdleHands supports multiple onboarding paths depending on where the Gateway runs
...
- [`idlehands onboard` command](/cli/onboard)

## macOS app onboarding

Use the IdleHands app when you want a fully guided setup on macOS. Docs:
