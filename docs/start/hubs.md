---
summary: "Hubs that link to every IdleHands doc"
read_when:
...
<Note>
If you are new to IdleHands, start with [Getting Started](/start/getting-started).
</Note>
...
- [IdleHands assistant](/start/idlehands)
