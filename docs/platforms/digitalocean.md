---
summary: "IdleHands on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up IdleHands on DigitalOcean
  - Looking for cheap VPS hosting for IdleHands
title: "DigitalOcean"
---

# IdleHands on DigitalOcean

## Goal

Run a persistent IdleHands Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
- `~/.idlehands/workspace/` — workspace (SOUL.md, memory, etc.)
