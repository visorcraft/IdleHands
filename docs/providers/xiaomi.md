---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with IdleHands"
read_when:
  - You want Xiaomi MiMo models in IdleHands
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). IdleHands uses
