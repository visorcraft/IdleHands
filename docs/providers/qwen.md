---
summary: "Use Qwen OAuth (free tier) in IdleHands"
read_when:
  - You want to use Qwen with IdleHands
...
If you already logged in with the Qwen Code CLI, IdleHands will sync credentials
