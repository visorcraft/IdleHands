...
You can point IdleHands at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or IdleHands
...
- [Anthropic provider](/providers/anthropic) - Native IdleHands integration with Claude setup-token or API keys
