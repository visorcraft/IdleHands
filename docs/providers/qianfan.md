---
summary: "Use Qianfan's unified API to access many models in IdleHands"
read_when:
...
3. IdleHands installed on your system
...
4. Copy the API key for use with IdleHands

## CLI setup

```bash
idlehands onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [IdleHands Configuration](/gateway/configuration)
