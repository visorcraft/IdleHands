---
summary: "Use NVIDIA's OpenAI-compatible API in IdleHands"
read_when:
  - You want to use NVIDIA models in IdleHands
...
idlehands onboard --auth-choice skip
idlehands models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
