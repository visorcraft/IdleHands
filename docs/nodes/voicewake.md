...
IdleHands treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.idlehands/settings/voicewake.json`

Shape:

```json
{ "triggers": ["idlehands", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
