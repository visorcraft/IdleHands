...
export function listBindings(cfg: IdleHandsConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: IdleHandsConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: IdleHandsConfig) {
