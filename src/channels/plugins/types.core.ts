...
export type ChannelAgentToolFactory = (params: { cfg?: IdleHandsConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: IdleHandsConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: IdleHandsConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: IdleHandsConfig }) => boolean;
  supportsCards?: (params: { cfg: IdleHandsConfig }) => boolean;
