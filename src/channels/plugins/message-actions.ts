...
export function listChannelMessageActions(cfg: IdleHandsConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: IdleHandsConfig): boolean {
...
export function supportsChannelMessageCards(cfg: IdleHandsConfig): boolean {
