...
import { discoverIdleHandsPlugins } from "../../plugins/discovery.js";
import type { IdleHandsPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, IdleHandsPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["IDLEHANDS_PLUGIN_CATALOG_PATHS", "IDLEHANDS_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<IdleHandsPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: IdleHandsPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: IdleHandsPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverIdleHandsPlugins({ workspaceDir: options.workspaceDir });
