...
export function listWhatsAppAuthDirs(cfg: IdleHandsConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: IdleHandsConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: IdleHandsConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: IdleHandsConfig): ResolvedWhatsAppAccount[] {
