...
function resolveAdaptiveReadMaxBytes(options?: IdleHandsReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createIdleHandsReadTool(base, {
...
export function createIdleHandsReadTool(
  base: AnyAgentTool,
  options?: IdleHandsReadToolOptions,
): AnyAgentTool {
