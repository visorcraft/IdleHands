...
function resolveAvatarSource(cfg: IdleHandsConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: IdleHandsConfig, agentId: string): AgentAvatarResolution {
