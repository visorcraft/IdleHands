...
function resolveWatchPaths(workspaceDir: string, config?: IdleHandsConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: IdleHandsConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: IdleHandsConfig }) {
