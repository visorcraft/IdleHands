...
export const DEFAULT_SANDBOX_IMAGE = "idlehands-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "idlehands-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "idlehands-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "idlehands-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "idlehands-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "idlehands-sandbox-browser";
