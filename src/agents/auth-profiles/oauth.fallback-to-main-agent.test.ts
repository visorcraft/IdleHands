...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveIdleHandsAgentDir() returns mainAgentDir
    process.env.IDLEHANDS_STATE_DIR = tmpDir;
    process.env.IDLEHANDS_AGENT_DIR = mainAgentDir;
