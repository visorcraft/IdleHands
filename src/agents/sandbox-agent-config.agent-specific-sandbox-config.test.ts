...
async function resolveContext(config: IdleHandsConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): IdleHandsConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
