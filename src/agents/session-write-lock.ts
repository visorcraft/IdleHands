...
const CLEANUP_STATE_KEY = Symbol.for("idlehands.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("idlehands.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("idlehands.sessionWriteLockWatchdogState");
