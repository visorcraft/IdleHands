...
type AgentEntry = NonNullable<NonNullable<IdleHandsConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: IdleHandsConfig): AgentEntry[] {
...
export function listAgentIds(cfg: IdleHandsConfig): string[] {
...
export function resolveDefaultAgentId(cfg: IdleHandsConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: IdleHandsConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: IdleHandsConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: IdleHandsConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: IdleHandsConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
