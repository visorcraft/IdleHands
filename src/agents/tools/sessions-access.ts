...
export function resolveSessionToolsVisibility(cfg: IdleHandsConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: IdleHandsConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: IdleHandsConfig): AgentToAgentPolicy {
