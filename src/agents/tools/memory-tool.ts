...
function resolveMemoryToolContext(options: { config?: IdleHandsConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: IdleHandsConfig): MemoryCitationsMode {
