...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): IdleHandsConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: IdleHandsConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: IdleHandsConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
