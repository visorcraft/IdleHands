...
function asIdleHandsConfig(config: Partial<IdleHandsConfig>): IdleHandsConfig {
  return config as IdleHandsConfig;
}

function createToolConfig() {
  return asIdleHandsConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: IdleHandsConfig = createToolConfig()) {
