...
function listConfiguredAgentIds(cfg: IdleHandsConfig): string[] {
...
export function listAgentsForGateway(cfg: IdleHandsConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: IdleHandsConfig): string {
...
function resolveSessionStoreAgentId(cfg: IdleHandsConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: IdleHandsConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: IdleHandsConfig): GatewaySessionsDefaults {
