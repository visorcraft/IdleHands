...
function cfg(input: Partial<IdleHandsConfig>): IdleHandsConfig {
  return input as IdleHandsConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<IdleHandsConfig["gateway"]>;
...
const DEFAULT_GATEWAY_ENV = {
  IDLEHANDS_GATEWAY_TOKEN: "env-token",
  IDLEHANDS_GATEWAY_PASSWORD: "env-password",
