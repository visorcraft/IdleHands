...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@idlehands", { botUsername: "idlehands" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@idlehands args", {
        botUsername: "idlehands",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@idlehands: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "idlehands" })).toBe(
      "/help@otherbot",
    );
  });
