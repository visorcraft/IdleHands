...
export async function prependSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: IdleHandsConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: IdleHandsConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.IDLEHANDS_TEST_FAST === "1") {
