...
function resolveMentionPatterns(cfg: IdleHandsConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: IdleHandsConfig | undefined, agentId?: string): RegExp[] {
