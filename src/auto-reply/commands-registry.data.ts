...
function buildChatCommands(): ChatCommandDefinition[] {
  const commands: ChatCommandDefinition[] = [
    ...
    defineChatCommand({
      key: "anton",
      nativeName: "anton",
      description: "Autonomous task executor — run, check status, or stop.",
      textAlias: "/anton",
      category: "tools",
      args: [
        {
          name: "taskfile_or_action",
          description: "Task file path, 'status', or 'stop'",
          type: "string",
          captureRemaining: true,
        },
      ],
    ...
    defineChatCommand({
      key: "dir",
      nativeName: "dir",
      description: "Show or set the workspace directory.",
      textAlias: "/dir",
      category: "management",
      args: [
        {
          name: "path",
          description: "New workspace path (omit to show current)",
          type: "string",
          captureRemaining: true,
        },
      ],
