...
export function isCommandEnabled(cfg: IdleHandsConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: IdleHandsConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: IdleHandsConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: IdleHandsConfig) {
