...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.IDLEHANDS_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: IdleHandsConfig): string[] {
...
export function listTelegramAccountIds(cfg: IdleHandsConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: IdleHandsConfig): string {
...
function mergeTelegramAccountConfig(cfg: IdleHandsConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: IdleHandsConfig): ResolvedTelegramAccount[] {
