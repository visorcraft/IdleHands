...
function registerAndResolveStatusHandler(cfg: IdleHandsConfig): TelegramCommandHandler {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/idlehands-sessions.json");
