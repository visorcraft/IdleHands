...
function mergeSlackAccountConfig(cfg: IdleHandsConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: IdleHandsConfig): ResolvedSlackAccount[] {
