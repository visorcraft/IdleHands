...
// Prefix for IdleHands-generated action IDs to scope our handler
const IDLEHANDS_ACTION_PREFIX = "idlehands:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${IDLEHANDS_ACTION_PREFIX}`);

  // Handle IdleHands modal submissions with callback_ids scoped by our prefix.
