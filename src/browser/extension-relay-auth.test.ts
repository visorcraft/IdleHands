...
import {
  probeAuthenticatedIdleHandsRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated idlehands relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedIdleHandsRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-idlehands-relay-token",
