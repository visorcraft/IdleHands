...
const loadIdleHandsPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadIdleHandsPlugins: (params: unknown) => loadIdleHandsPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadIdleHandsPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadIdleHandsPluginsMock.mockClear();
  });
