...
export const PLUGIN_MANIFEST_FILENAME = "idlehands.plugin.json";
...
// package.json "idlehands" metadata (used for onboarding/catalog)
...
export type IdleHandsPackageManifest = {
  extensions?: string[];
...
): IdleHandsPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
