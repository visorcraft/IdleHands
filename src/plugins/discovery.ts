...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @idlehands/voice-call -> voice-call).
...
export function discoverIdleHandsPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".idlehands", "extensions")];
