...
export type IdleHandsPluginConfigSchema = {
...
export type IdleHandsPluginToolContext = {
...
export type IdleHandsPluginToolFactory = (
  ctx: IdleHandsPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type IdleHandsPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type IdleHandsPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<IdleHandsConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type IdleHandsPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current IdleHands configuration */
  config: IdleHandsConfig;
 ...
 */
export type IdleHandsPluginCommandDefinition = {
...
export type IdleHandsPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type IdleHandsPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type IdleHandsPluginCliContext = {
  program: Command;
  config: IdleHandsConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type IdleHandsPluginCliRegistrar = (ctx: IdleHandsPluginCliContext) => void | Promise<void>;

export type IdleHandsPluginServiceContext = {
  config: IdleHandsConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type IdleHandsPluginService = {
  id: string;
  start: (ctx: IdleHandsPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: IdleHandsPluginServiceContext) => void | Promise<void>;
};

export type IdleHandsPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type IdleHandsPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: IdleHandsPluginConfigSchema;
  register?: (api: IdleHandsPluginApi) => void | Promise<void>;
  activate?: (api: IdleHandsPluginApi) => void | Promise<void>;
};

export type IdleHandsPluginModule =
  | IdleHandsPluginDefinition
  | ((api: IdleHandsPluginApi) => void | Promise<void>);

export type IdleHandsPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | IdleHandsPluginToolFactory,
    opts?: IdleHandsPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: IdleHandsPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: IdleHandsPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: IdleHandsPluginHttpRouteHandler }) => void;
  registerChannel: (registration: IdleHandsPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: IdleHandsPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: IdleHandsPluginService) => void;
   ...
   */
  registerCommand: (command: IdleHandsPluginCommandDefinition) => void;
