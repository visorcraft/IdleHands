...
export const normalizePluginsConfig = (
  config?: IdleHandsConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: IdleHandsConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: IdleHandsConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: IdleHandsConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
