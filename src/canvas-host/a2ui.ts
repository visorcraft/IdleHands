...
export const A2UI_PATH = "/__idlehands__/a2ui";

export const CANVAS_HOST_PATH = "/__idlehands__/canvas";

export const CANVAS_WS_PATH = "/__idlehands__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.idlehandsCanvasA2UIAction.postMessage(...)
  // - Android: window.idlehandsCanvasA2UIAction.postMessage(...)
  const handlerNames = ["idlehandsCanvasA2UIAction"];
  ...
  globalThis.IdleHands = globalThis.IdleHands ?? {};
  globalThis.IdleHands.postMessage = postToNode;
  globalThis.IdleHands.sendUserAction = sendUserAction;
  globalThis.idlehandsPostMessage = postToNode;
  globalThis.idlehandsSendUserAction = sendUserAction;
