...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: IdleHandsConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: IdleHandsConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__idlehandsMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__idlehandsMcporterColdStartWarned;
  });
