...
function resolveGatewayPort(cfg: IdleHandsConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: IdleHandsConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.IDLEHANDS_GATEWAY_PASSWORD?.trim() ||
