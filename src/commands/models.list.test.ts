...
const ensureIdleHandsModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveIdleHandsAgentDir = vi.fn().mockReturnValue("/tmp/idlehands-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/idlehands-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureIdleHandsModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveIdleHandsAgentDir,
}));
