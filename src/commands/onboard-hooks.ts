...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.idlehands.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("idlehands hooks list")}`,
      `  ${formatCliCommand("idlehands hooks enable <name>")}`,
      `  ${formatCliCommand("idlehands hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
