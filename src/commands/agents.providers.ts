...
function resolveDefaultAccountId(cfg: IdleHandsConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: IdleHandsConfig): boolean {
...
export function summarizeBindings(cfg: IdleHandsConfig, bindings: AgentBinding[]): string[] {
