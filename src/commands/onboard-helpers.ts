...
export function summarizeExistingConfig(config: IdleHandsConfig): string {
  const rows: string[] = [];
...
export function printWizardHeader(runtime: RuntimeEnv) {
  const header = [
    "+--------------------------------+",
    "|  III DDD  L    EEEE H  H AAA  |",
    "|   I  D  D L    E    H  H A  A |",
    "|   I  D  D L    EEE  HHHH AAAA |",
    "|   I  D  D L    E    H  H A  A |",
    "|  III DDD  LLLL EEEE H  H A  A |",
    "|           IDLEHANDS           |",
    "+--------------------------------+",
    " ",
  ].join("\n");
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.idlehands.ai/gateway/remote",
    "https://docs.idlehands.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
