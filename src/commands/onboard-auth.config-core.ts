...
export function applyOpenrouterProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: IdleHandsConfig): IdleHandsConfig {
...
export function applyMoonshotConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: IdleHandsConfig): IdleHandsConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: IdleHandsConfig): IdleHandsConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: IdleHandsConfig): IdleHandsConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: IdleHandsConfig): IdleHandsConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: IdleHandsConfig): IdleHandsConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: IdleHandsConfig): IdleHandsConfig {
...
export function applyQianfanProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: IdleHandsConfig): IdleHandsConfig {
