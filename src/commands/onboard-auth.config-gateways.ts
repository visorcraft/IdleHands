...
export function applyVercelAiGatewayProviderConfig(cfg: IdleHandsConfig): IdleHandsConfig {
...
export function applyVercelAiGatewayConfig(cfg: IdleHandsConfig): IdleHandsConfig {
