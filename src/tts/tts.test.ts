...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.IDLEHANDS_TTS_PREFS;
      process.env.IDLEHANDS_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.IDLEHANDS_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: IdleHandsConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
