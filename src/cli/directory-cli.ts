    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["idlehands directory self --channel slack", "Show the connected account identity."],
          [
            'idlehands directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["idlehands directory groups list --channel discord", "List available groups/channels."],
          [
            "idlehands directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.idlehands.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
