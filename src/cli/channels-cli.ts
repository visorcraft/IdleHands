    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["idlehands channels list", "List configured channels and auth profiles."],
          ["idlehands channels status --probe", "Run channel status checks and probes."],
          [
            "idlehands channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["idlehands channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.idlehands.ai/cli/channels",
        )}\n`,
    );
