...
const SANDBOX_EXAMPLES = {
  main: [
    ["idlehands sandbox list", "List all sandbox containers."],
    ["idlehands sandbox list --browser", "List only browser containers."],
    ["idlehands sandbox recreate --all", "Recreate all containers."],
    ["idlehands sandbox recreate --session main", "Recreate a specific session."],
    ["idlehands sandbox recreate --agent mybot", "Recreate agent containers."],
    ["idlehands sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["idlehands sandbox list", "List all sandbox containers."],
    ["idlehands sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["idlehands sandbox recreate --all", "Recreate all containers."],
    ["idlehands sandbox recreate --session main", "Recreate a specific session."],
    ["idlehands sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["idlehands sandbox recreate --browser --all", "Recreate only browser containers."],
    ["idlehands sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["idlehands sandbox explain", "Show effective sandbox config."],
    ["idlehands sandbox explain --session agent:main:main", "Explain a specific session."],
    ["idlehands sandbox explain --agent work", "Explain an agent sandbox."],
    ["idlehands sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.idlehands.ai/cli/sandbox")}\n`,
    )
    .action(() => {
