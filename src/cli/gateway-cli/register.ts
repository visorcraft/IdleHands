      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["idlehands gateway run", "Run the gateway in the foreground."],
            ["idlehands gateway status", "Show service status and probe reachability."],
            ["idlehands gateway discover", "Find local and wide-area gateway beacons."],
            ["idlehands gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.idlehands.ai/cli/gateway")}\n`,
      ),
  );
