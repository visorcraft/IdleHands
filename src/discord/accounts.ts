...
function mergeDiscordAccountConfig(cfg: IdleHandsConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: IdleHandsConfig): ResolvedDiscordAccount[] {
