...
const CORE_PACKAGE_NAMES = new Set(["idlehands", "@visorcraft/idlehands"]);
...
export async function resolveIdleHandsPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveIdleHandsPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
