...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: IdleHandsConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: IdleHandsConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: IdleHandsConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: IdleHandsConfig }): Promise<void> {
