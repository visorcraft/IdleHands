...
type SecretDefaults = NonNullable<IdleHandsConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: IdleHandsConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveIdleHandsAgentDir()));
