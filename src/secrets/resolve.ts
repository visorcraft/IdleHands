...
function resolveResolutionLimits(config: IdleHandsConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: IdleHandsConfig): SecretProviderConfig {
