...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.idlehands.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", IDLEHANDS_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.idlehands.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.idlehands.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when IDLEHANDS_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.idlehands.gateway.plist",
    },
    {
      name: "uses profile-specific label when IDLEHANDS_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", IDLEHANDS_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.idlehands.jbphoenix.plist",
    },
    {
      name: "prefers IDLEHANDS_LAUNCHD_LABEL over IDLEHANDS_PROFILE",
      env: {
        HOME: "/Users/test",
        IDLEHANDS_PROFILE: "jbphoenix",
        IDLEHANDS_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from IDLEHANDS_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        IDLEHANDS_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty IDLEHANDS_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        IDLEHANDS_PROFILE: "myprofile",
        IDLEHANDS_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.idlehands.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
