...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof IdleHandsConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: IdleHandsConfig; env: NodeJS.ProcessEnv }): {
  cfg: IdleHandsConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
