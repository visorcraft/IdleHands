...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/idlehands/idlehands/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.IDLEHANDS_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.idlehands/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: IdleHandsConfig = {
    ...params.cfg,
  ...
  const workspace = await ensureAgentWorkspace({
    ...
    agentIdentityEnabled: isAgentIdentityEnabled(cfgWithAgentDefaults),
  });
