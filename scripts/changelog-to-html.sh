...
if [[ -z "$version_content" ]]; then
  echo "<h2>IdleHands $VERSION</h2>"
  echo "<p>Latest IdleHands update.</p>"
  echo "<p><a href=\"https://github.com/idlehands/idlehands/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
