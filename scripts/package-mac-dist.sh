...
# Output:
# - dist/IdleHands.app
# - dist/IdleHands-<version>.zip
# - dist/IdleHands-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.idlehands.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/IdleHands.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/IdleHands-$VERSION.zip"
DMG="$ROOT_DIR/dist/IdleHands-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/IdleHands-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/IdleHands-$VERSION.dSYM.zip"
