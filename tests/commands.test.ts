...
describe('custom commands', () => {
  ...
  before(async () => {
    ...
    prevConfigDir = process.env.IDLEHANDS_CONFIG_DIR;
    prevXdgConfig = process.env.XDG_CONFIG_HOME;
    process.env.HOME = tmpHome;
    // Ensure configDir() uses our temp HOME — clear overrides that take priority
  ...
  after(async () => {
    ...
    if (prevConfigDir === undefined) delete process.env.IDLEHANDS_CONFIG_DIR;
    else process.env.IDLEHANDS_CONFIG_DIR = prevConfigDir;
